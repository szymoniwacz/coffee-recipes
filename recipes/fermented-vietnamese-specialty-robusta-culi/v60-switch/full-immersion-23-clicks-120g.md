...
More body, sweetness and concentration while keeping fermentation character under control — without the dilution seen at 140 g or the bitterness from 22 clicks.
...
|---|---|---:|---:|---|---|---|
| Main pour | closed | 120 g | 120 g | 0:00 | 1:30 | Pour immediately to 120 g; valve closed |
| Release | open | — | 120 g | 1:30 | ~2:00 | Open Switch; drawdown complete ~2:00 (estimated from experiment 2) |
| Post-drawdown rest | closed / open | — | 120 g | ~2:00 | ~3:00 | Wait ~60 s before serving |
...
- Drawdown time after release: ~30 s (drawdown finished ~2:00 in experiment 2 at same release time)
- Total brew time: ~2:00 brew + ~60 s post-drawdown rest (~3:00 workflow)
...
- **Full immersion, no bloom:** experiments 2 and 3 outperformed experiment 1 (bloom + 24 clicks) — immediate closed-valve immersion gives more flavor and less dilution.
- **23 clicks:** sweet spot between experiment 1 (24 clicks — thin, low body) and experiment 3 (22 clicks — more intensity but light bitterness and still diluted).
...
| Less bitterness | coarser than 22 clicks (23 or 24); do not extend immersion beyond 1:30 without logging |
...
|---|---|---|
| Watery / hollow | too coarse, too much water, or bloom diluting immersion | finer toward 23 clicks; reduce water; skip bloom |
...
- See also:
  ...
  - [V60 — Sweetness + body](../../robusta-honey/v60/sweetness-body.md)
  - [V60 — Strong](../../robusta-honey/v60/strong.md)
